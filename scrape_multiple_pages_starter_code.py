...
for page_number in range(1,4):
    ...
    # define the url
    url = "https://techcrunch.com/category/artificial-intelligence/page/"+str(page_number)+"/"
    ...
    title_elements = parsed_response.find_all("a", class_="loop-card__title-link")

    # extract all the elements specific to book authors from that page
    author_elements = parsed_response.find_all("a", class_="loop-card__author")
